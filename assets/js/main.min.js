...
function setActiveColor(el) {
    ...
    // Находим активный tab-content и работаем только внутри него
    let activeTab = $(parentBlock).find(".tab-content._active")
    $(activeTab).find(".color-tab-content").removeClass("_active")
    $(activeTab).find(`.${tabId}`).addClass("_active")  // ← ищем только в активном табе
}
